...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  principal     = "apigateway.amazonaws.com"
   ...
   source_arn = "arn:aws:execute-api:${var.region}:${data.aws_caller_identity.current.account_id}:${aws_api_gateway_rest_api.apig.id}/*/${aws_api_gateway_method.apig_method.http_method}${aws_api_gateway_resource.apig_resource.path}"
}